...
from initiator.parameters import NB_STO_PER_HOU
...
all_ind_hou = build_individual_houses_map(N_INDIVIDUALS)
...
all_hou_sto = build_house_store_map(geo_sto, geo_hou, int(len(all_hou_ind)))
...
# draw_population_state_daily(stats, N_days, N)
