...
from scenario.helper.scenario import soften_full_lockdown, tighten_full_lockdown, measure_lockdown_strength, \
    get_zero_stats, is_weekend
...
def launch_run(params, env_dic, display_progress=True):
    ...
    for r in range(params[nrun_key]):
        ...
        for day in range(params[nday_key]):
            ...
            if stats['hos'][r][day] >= available_beds * factor_bed and days_to_lockdown_change >= 7 \
